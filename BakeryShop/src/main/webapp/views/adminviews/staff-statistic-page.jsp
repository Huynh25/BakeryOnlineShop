...
<html>
    ...
    <body>
        <div class="container-fluid position-relative d-flex p-0 row">
            <div class="sidebar pe-4 pb-3 col-sm-3">
                <nav class="navbar bg-secondary navbar-white">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="../../staff-management" class="nav-item nav-link"><i class="bi bi-skip-backward-fill"></i> Back</a>
                    </div>
                </nav>
            </div>
                            ...
                            <div class="bg-secondary rounded h-100">
                                ...
                                <div class="option-dropdown">
                                    <div class="dropdown" id="line-chart-option-dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" id="option-chat-btn" type="button" data-toggle="dropdown" aria-expanded="false">
                                            Total Income
                                        </button>
                                        <div class="dropdown-menu" id="option-chart">
            ...
            <script src="../../assets/javascript/staff-data-chart.js"></script>
    </body>
</html>
