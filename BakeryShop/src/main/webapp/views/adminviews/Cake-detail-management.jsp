        ...
        <div class="content container-fluid">
            ...
            <div class=" content-cake">
                <div class="d-flex justify-content-center">
                    <h1 class="title-update">Update Cake</h1>
                </div>
                <div class="row">
                    <div id="image-container" class="img-container position-relative">
                        ...
                        <img class="cake-img" id="cake-image" src="../../${cake.cakeImg}" alt="alt" data-original-image="../../${cake.cakeImg}" />
                    </div>
                    ...
                    <form id="updateCakeForm" class="col-sm-6 row" action="CakeDetailManagement" method="POST">
                        <div class="col-sm-2" id="form-row-1">
                            ...
                            <input style="text-align:center;" id="cake-id" name="cake-id" type="text" value="${cake.cakeID}" placeholder="Enter Cake ID" oninput="resetError(`cake-id-error`)" readonly  />
                ...
                <div class="popup-content">
                    <p>Are you sure update this cake?</p>
