        ...
        <div class="content container-fluid">
            ...
            <div class=" content-topping">
                <div class="d-flex justify-content-center">
                    <h1 class="title-update">Update Topping</h1>
                </div>
                <div class="row">
                    <div id="image-container" class="img-container position-relative">
                        ...
                        <img class="topping-img" id="topping-image" src="../../${topping.toppingImg}" alt="alt" data-original-image="../../${topping.toppingImg}" />
                    </div>
                    ...
                    <form id="updateToppingForm" class="col-sm-6 row" action="ToppingDetailManagement" method="POST">
                        <div class="col-sm-2" id="form-row-1">
                            ...
                            <input style="text-align:center;" id="topping-id" name="topping-id" type="text" value="${topping.toppingID}" placeholder="Enter Topping ID" oninput="resetError(`topping-id-error`)" readonly  />
                    ...
                    <div class="container-fluid d-flex justify-content-center">
                        <button id="edit-btn" onclick="showPopup()" type="button">Edit</button>
                    </div>
                </div>
            </div>
                            <div id="acceptOrderPopup" class="popup">
                <div class="popup-content">
                    <p>Are you sure update this topping?</p>
                    <button onclick="sendDataToServlet()">Yes</button>
            ...
            <div id="contactPopup" class="popup">
                <div class="popup-content">
                    <p class="successfully-notice">Update Successfully</p>
