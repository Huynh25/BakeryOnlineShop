...
<html>
    ...
    <body>
        ...
        <div class="form-edit">
            <form action="changePasswordStaff" method="post" class="form" onsubmit="return validatePasswordStaff()" class="needs-validation" novalidate>
        ...
        <script src="../../assets/javascript/changePasswordStaff.js"></script>
    </body>
</html>
