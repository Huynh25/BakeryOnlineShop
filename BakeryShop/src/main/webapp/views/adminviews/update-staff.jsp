    ...
    <body>
        ...
        <div id="content" class="row">
            ...
            <div id="avatar-container" class="col-sm-3">
                <input type="image" id="staff-avatar" src="${staff.staffAvatar}" onclick="openFilePicker()" /> 
            ...
            <div id="form-container" class="col-sm-8">
                <form id="staff-form" class="row" action="../../staff-management" method="POST">
                    ...
                    <div class="col-sm-4" id="form-row-1">
                        <label for="staff-name" id="staff-name-label" >Staff Name</label>
                        <input id="staff-name" name="staff-name" type="text" class="readOnly" value="${staff.staffName}" readonly="" />
                    </div>
                    ...
                    <div class="col-sm-6" id="form-row-3">                       
                        ...
                        <input id="fullname" name="fullname" type="text" placeholder="Enter FullName" value="${staff.fullname}" oninput="resetError(`fullname-error`)" />
                        <div id="fullname-error"></div>
                    </div>
                    <div class="col-sm-6" id="form-row-4">                      
                        <label for="phoneNumber" id="phoneNumber-label">PhoneNumber</label>
                        <input id="phoneNumber" name="phoneNumber" type="number" placeholder="Enter PhoneNumber" value="${staff.phoneNumber}" oninput="resetError(`phoneNumber-error`)" />
                        <div id="phoneNumber-error"></div>
                    </div>
                    <div class="col-sm-12" id="form-row-5">                        
                        <label for="email" id="email-label">Email</label>
                        <input id="email" name="email" type="email" placeholder="Enter Email" value="${staff.email}" oninput="resetError(`email-error`)" />
