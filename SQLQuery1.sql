...
CREATE TABLE [Orders](
	...
	[staffID] int NOT NULL foreign key references Staffs(staffID),
...
VALUES 
    ('luffy', 'onepiece', 'Monkey D. Luffy', 'luffy@strawhatpirates.com', NULL, NULL, 'Image/Avatar/luffy.jpg', 'Thousand Sunny, East Blue', '0123456789'),
    ('voldemort', 'darklord', 'Lord Voldemort', 'voldemort@deathEaters.com', NULL, NULL, 'Image/Avatar/voldemort.jpg', 'Malfoy Manor, Wiltshire', '0987654321'),
    ('mickeymouse', 'disney', 'Mickey Mouse', 'mickey@disney.com', NULL, NULL, 'Image/Avatar/mickeymouse.jpg', 'Disneyland, Anaheim, California', '0123456789'),
    ('darthvader', 'sithlord', 'Darth Vader', 'vader@empire.com', NULL, NULL, 'Image/Avatar/darthvader.jpg', 'Death Star, Outer Rim Territories', '0987654321'),
    ('sherlockholmes', 'elementary', 'Sherlock Holmes', 'sherlock@bakerstreet.com', NULL, NULL, 'Image/Avatar/sherlockholmes.jpg', '221B Baker Street, London', '0123456789'),
    ('winniethepooh', 'honey', 'Winnie the Pooh', 'pooh@hundredacrewood.com', NULL, NULL, 'Image/Avatar/winniethepooh.jpg', 'Hundred Acre Wood', '0987654321'),
    ('hanniballecter', 'favaBeans', 'Hannibal Lecter', 'hannibal@psychiatrist.com', NULL, NULL, 'Image/Avatar/hanniballecter.jpg', 'Baltimore State Hospital for the Criminally Insane', '0123456789'),
    ('elizabethbennet', 'prideprejudice', 'Elizabeth Bennet', 'elizabeth@longbourn.com', NULL, NULL, 'Image/Avatar/elizabethbennet.jpg', 'Longbourn Estate, Hertfordshire', '0987654321'),
    ('michaeljackson', 'moonwalk', 'Michael Jackson', 'michael@neverlandranch.com', NULL, NULL, 'Image/Avatar/michaeljackson.jpg', 'Neverland Ranch, California', '0123456789'),
    ('pikachu', 'thunderbolt', 'Pikachu', 'pikachu@pokemon.com', NULL, NULL, 'Image/Avatar/pikachu.jpg', 'Pallet Town, Kanto', '0987654321'),
    ('harrypotter', 'hogwarts', 'Harry Potter', 'harry@hogwarts.com', NULL, NULL, 'Image/Avatar/harrypotter.jpg', '4 Privet Drive, Little Whinging, Surrey', '0123456789'),
    ('ironman', 'tonystark', 'Tony Stark', 'tony@starkindustries.com', NULL, NULL, 'Image/Avatar/ironman.jpg', 'Stark Tower, New York', '0987654321'),
    ('batman', 'brucewayne', 'Bruce Wayne', 'bruce@wayneenterprises.com', NULL, NULL, 'Image/Avatar/batman.jpg', 'Wayne Manor, Gotham City', '0123456789'),
    ('wonderwoman', 'amazon', 'Diana Prince', 'diana@themyscira.com', NULL, NULL, 'Image/Avatar/wonderwoman.jpg', 'Themyscira, Paradise Island', '0987654321'),
    ('spiderman', 'peterparker', 'Peter Parker', 'peter@dailybugle.com', NULL, NULL, 'Image/Avatar/spiderman.jpg', 'Queens, New York City', '0123456789'),
    ('jamesbond', '007', 'James Bond', 'james@mi6.com', NULL, NULL, 'Image/Avatar/jamesbond.jpg', 'London, England', '0987654321'),
    ('gandalf', 'youshallnotpass', 'Gandalf the Grey', 'gandalf@greyhavens.com', NULL, NULL, 'Image/Avatar/gandalf.jpg', 'The Shire, Middle-earth', '0123456789'),
    ('deadpool', 'chimichangas', 'Deadpool', 'deadpool@mercwithamouth.com', NULL, NULL, 'Image/Avatar/deadpool.jpg', 'New York City', '0987654321'),
    ('joker', 'whysoserious', 'The Joker', 'joker@arkhamasylum.com', NULL, NULL, 'Image/Avatar/joker.jpg', 'Gotham City', '0123456789'),
    ('lukeSkywalker', 'usetheforce', 'Luke Skywalker', 'luke@rebels.com', NULL, NULL, 'Image/Avatar/lukeskywalker.jpg', 'Tatooine', '0987654321');
...
VALUES 
    (1, 5, N'Bánh sinh nhật cho bữa tiệc sinh nhật lần thứ 30 của John.', 500000, '2024-01-10', '2024-01-02', 1, 'Done'),
    (2, 4, N'Bánh cưới với hoa trang trí cho đám cưới của Smith-Jones', 400000, '2024-01-09', '2024-01-03', 0, 'Delivering'),
    (3, 9, N'Bánh kỷ niệm cho kỷ niệm 10 năm kết hôn.', 700000, '2024-01-09', '2024-01-04', 0, 'Watting'),
    (4, 6, N'Bánh tùy chỉnh cho sự kiện kỷ niệm hàng năm của công ty', 250000, '2024-01-09', '2024-01-05', 1, 'Delivering'),
    (5, 1, N'Bánh đặc biệt cho lễ tốt nghiệp của Mary Smith.', 650000, '2024-01-08', '2024-01-06', 1, 'Watting'),
    (6, 2, N'Bánh theo chủ đề ngày lễ cho bữa tiệc Giáng sinh.', 390000, '2024-01-08', '2024-01-07', 1, 'Done'),
    (7, 3, N'Bánh tiệc cho sự kiện tổ chức tiệc mừng sinh em bé của gia đình Johnson.', 570000, '2024-01-06', '2024-01-08', 0, 'Done'),
    (8, 4, N'Bánh chia tay cho bữa tiệc nghỉ hưu của đồng nghiệp.', 600000, '2024-01-05', '2024-01-09', 1, 'Done'),
    (9, 10, N'Bánh cho sự kiện gây quỹ ủng hộ từ thiện địa phương.', 470000, '2024-01-05', '2024-01-10', 1, 'Done'),
    (10, 8, N'Bánh bất ngờ giao cho buổi tiệc chúc mừng việc thăng chức của Jane.', 350000, '2024-01-05', '2024-01-11', 1, 'Done');
...
VALUES 
    ...
    ('Coconut Flakes', 28000, 4.50, 'Image/Topping/coconut_flakes.jpg', 'Crunchy coconut flakes'),
    ('Jelly Beans', 18000, 5.50, 'Image/Topping/jelly_beans.jpg', 'Colorful jelly beans'),
    ('Gummy Bears', 8000, 6.50, 'Image/Topping/gummy_bears.jpg', 'Chewy gummy bears');
...
VALUES 
    (50, '2024-01-01', '2024-01-01', 1, 1, 1, 1),
    (40, '2024-01-02', '2024-01-02', 2, 2, 2, 2),
    (30, '2024-01-03', '2024-01-03', 3, 3, 3, 3),
    (20, '2024-01-04', '2024-01-04', 4, 4, 4, 4),
    (15, '2024-01-05', '2024-01-05', 5, 5, 5, 5),
    (25, '2024-01-06', '2024-01-06', 6, 6, 6, 6),
    (35, '2024-01-07', '2024-01-07', 7, 7, 7, 7),
    (45, '2024-01-08', '2024-01-08', 8, 8, 8, 8),
    (55, '2024-01-09', '2024-01-09', 9, 9, 9, 9),
    (60, '2024-01-10', '2024-01-10', 10, 10, 10, 10);
